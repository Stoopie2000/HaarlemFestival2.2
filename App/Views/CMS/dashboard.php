...
<div class="content" id="dashboard">
    ...
    <div class="row">
        <div class="col">
            <div class="btn-big btn-big-style food_container">
        ...
        <div class="col">
                <div class="btn-big btn-big-style food_container no-padding">
    ...
    <div class="row">
        <div class="btn-big-style btn-pages food_container">
